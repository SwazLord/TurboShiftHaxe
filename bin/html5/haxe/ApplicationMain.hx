...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TurboShiftHaxe", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("TurboShiftHaxe", null, 640, 960);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["packageName"] = "com.theamaturedev.turboshifthaxe";
		...
		#elseif air
		app.window.title = "TurboShiftHaxe";
		#else
